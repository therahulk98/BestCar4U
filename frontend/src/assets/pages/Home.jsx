...
const Home = ({setHideNavBar, user, favoriteCars, API_BASE_URL}) => {
  ...
  const handleScroll = () => {
    ...
    window.scrollBy({ top: window.innerHeight-navbarHeight, behavior: "smooth" });
  };
  ...
  useEffect(() => {
    return () => setHideNavBar(false); // Reset navbar when leaving Home component
  }, []);
  ...
  return (
    <div className="flex items-center justify-center h-full text-center bg-gradient-to-r from-purple-500 to-red-500">
      <div className="w-full min-h-screen text-center">
        ...
        <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold shadow-md bg-gradient-to-r from-yellow-500 to-green-500 bg-clip-text text-transparent ">
